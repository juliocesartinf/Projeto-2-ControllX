    ...
    <div class="row">
      ...
      <div class="col-md-12"> 
        ...
        <div id="formulario">
          ...
          <form id="cadastro" action="<?php echo site_url('CadastroGerente/realizar_cadastro'); ?>  " method="post">
            <div class="form-group"> 
              ...
              <div class="form-group">
                <input type="email" maxlength="55" class="form-control" id="email" placeholder="E-mail" name="email">
              </div>
              <div class="form-group">
                <input type="password" maxlength="35" class="form-control" id="formGroupExampleInput" placeholder="Senha" name="senha">
              </div>
              <div class="form-group">
                <input type="password" maxlength="35" class="form-control" id="formGroupExampleInput" placeholder="Confirmar Senha" name="senhaC">
